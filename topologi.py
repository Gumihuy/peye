...
def run():
    ...
    # Tambahan untuk stabilitas link antar router
    r1.cmd('arp -s 10.0.1.2 00:00:00:00:01:02')
    r2.cmd('arp -s 10.0.1.1 00:00:00:00:01:01')
    r2.cmd('arp -s 10.0.3.2 00:00:00:00:03:02')
    r3.cmd('arp -s 10.0.3.1 00:00:00:00:03:01')
    ...
    info('\n*** Uji konektivitas keseluruhan (pingall) ***\n')
    net.pingAll()
