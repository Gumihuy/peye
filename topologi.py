...
def run():
    ...
    info("\n*** Ping antar-router dulu (aktivasi ARP) ***\n")
    r1.cmd('ping -c1 10.0.1.2')
    r2.cmd('ping -c1 10.0.3.2')
    r3.cmd('ping -c1 10.0.3.1')
    sleep(2)

    info("\n*** Tes koneksi dari R1 ke R3 via R2 ***\n")
    r1.cmdPrint('ping -c2 10.0.3.2')
    r1.cmdPrint('ping -c2 10.0.4.1')
